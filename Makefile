...
docker:
	docker stop app-stack || true
	docker rm app-stack || true
	docker rmi app-stack-img || true
	docker build -t app-stack-img -f Dockerfile.local .
	docker run -d --name app-stack app-stack-img
